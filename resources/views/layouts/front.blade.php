...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/assets/sidebar.css') }}" />
    <title>LMS</title>
    @stack('onepage_custom_style')
        ...
        <div class="nav container">
            <div class="nav-menu" id="nav-menu">
                <ul class="nav-list">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('home') }}" class="nav-link">My Trades</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('home') }}" class="nav-link">Request</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('home') }}" class="nav-link" style="position: relative;">
                            <img src="/images/bell2.png" alt="" srcset="" class="notification-ico">
                            <div class="notification-num">2</div>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.categories.index') }}" class="nav-link">Admin</a>
                    </li>
                    @endif
                    @endauth
                </ul>
...
{{--
    ...
    <footer class="footer section clearfix">
        ...
        <span class="footer-copy">&#169; POP</span>
    </footer>
        @if(isset($pagename) == "product" || isset($pagename) == "subcategory")
            @include('layouts.learn_sidebar')
        @endif
