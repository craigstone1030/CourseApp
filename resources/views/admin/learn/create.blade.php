...
<div class="card">
    ...
    <div class="card-body">
        <form id="learnFrm" action="{{ route('admin.learn.store') }}" method="POST" onsubmit="return checkValidation()" enctype="multipart/form-data">
            @csrf
...
@push("script-alt")
    <script>
        ...
        const checkValidation = () => {
            ...
            if(category_id == "0" || title == null) {
                toastr.warning("Category is required field!", "Warnning");
                return false;
